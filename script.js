...
function initDatabase() {
    // التحقق من وجود المهام في التخزين المحلي
...
function updateTaskInDatabase(updatedTask) {
    try {
...
function searchTasks(query) {
    ...
    return tasks.filter(task => 
        task.caseNumber.toLowerCase().includes(lowerQuery) ||
        task.reason.toLowerCase().includes(lowerQuery) ||
